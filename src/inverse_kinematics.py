...
def main():
    ...
    oculus = oculus_sub()
    initial_l = [0, 0, 0, 0.0001, 0, 0.0001, 0, 0]
    initial_r = [0, 0, 0, 0.0001, 0, -0.0001, 0, 0]
    rospy.sleep(0.5)
    print("Inverse Kinematics start!!!!!")

    while not rospy.is_shutdown():

        ik_goal_l, ik_goal_r = ik([0, 0, 0, 0.0001, 0.1, 1, 0.0001],[0, 0, 0, 0.0001, 0.1, -1, 0.0001], initial_l,initial_r)
